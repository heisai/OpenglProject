...
#include "../stb_image.h"
RectTextureEngine::RectTextureEngine(std::shared_ptr<Shader> shader):
    GraphicsEngine(shader)
{
	InitTextures(&m_Texture, Utils::GlslAbsolute("wall.jpg", "Rectangle"));
	InitTextures(&m_Texture1, Utils::GlslAbsolute("awesomeface.png", "Rectangle"), false);
}
